...
export const messages = {
  es: {
    'meta.title': 'Tropicool demo - Plant based & cocktail bar en X Madrid',
    'meta.description':
    ...
    'hero.text': 'Sabores atrevidos, street food vegetal y cócteles con alma tropical en X Madrid.',
    ...
    'intro.eyebrow': 'Sabores atrevidos',
    'intro.title': 'Cocina vegetal para compartir, beber bien y repetir plan.',
    'intro.text':
    ...
    'stats.items': 'referencias en carta',
    'stats.plant': 'plant based',
    'stats.location': 'Madrid',
    'featured.eyebrow': 'Platos que abren la puerta',
    'featured.title': 'Favoritos Tropicool',
    'featured.explore': 'Explorar carta',
    'menu.eyebrow': 'Carta completa',
    'menu.title': 'Todo lo que puedes pedir.',
    'menu.description':
  ...
  en: {
    ...
    'hero.kicker': '100% plant-based + cocktail bar',
    'hero.text': 'Bold flavors, plant-based street food and tropical cocktails at X Madrid.',
    'cta.reserve': 'Book',
    'cta.reserveTable': 'Book a table',
    'cta.fullMenu': 'View full menu',
    'cta.orderOnline': 'Order online',
    'cta.orderUber': 'Order on Uber Eats',
    'intro.eyebrow': 'Bold flavors',
    'intro.title': 'Plant-based food to share, drink well and come back for.',
    'intro.text':
      'Tropicool is born from travel, curiosity and tropical flavors. Everything is plant-based, with vegan alternatives and a menu made for sharing.',
    'stats.items': 'menu items',
    'stats.plant': 'plant-based',
    'stats.location': 'Madrid',
    'featured.eyebrow': 'A first taste',
    'featured.title': 'Tropicool favorites',
    'featured.explore': 'Explore menu',
    'menu.eyebrow': 'Full menu',
    'menu.title': 'Everything you can order.',
    'menu.description':
